# ECS Cluster (equivalent to Azure App Service)
  ...
  container_definitions = jsonencode([
    {
      ...
      secrets = [
        {
          name      = "DATABASE_URL"
          valueFrom = "${aws_secretsmanager_secret.app_database_credentials.arn}:connection_string::"
        },
        {
          name      = "JWT_SECRET"
          valueFrom = "${aws_secretsmanager_secret.app_jwt_secret.arn}:jwt_secret::"
        }
      ]
